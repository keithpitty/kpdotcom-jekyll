...
However, there are times when the need to provide an interface to another application mandates the use of SOAP or XML-RPC. Recently I had a need to provide an XML-RPC web service server within a Rails application. Fortunately, "a version of ActionWebService has been kept up to date":http://github.com/datanoise/actionwebservice/tree/master on GitHub "together with instructions":http://www.datanoise.com/articles/2008/7/2/actionwebservice-is-back for implementing it.
